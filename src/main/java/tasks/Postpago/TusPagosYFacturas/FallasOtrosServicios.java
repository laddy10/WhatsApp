...
public class FallasOtrosServicios implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(ClickTextoQueContengaX.elTextoContiene(OTROS_SERVICIOS_FALLAS));
        ...
        actor.attemptsTo(
                Click.on(BTN_CLARO_VIDEO), WaitForTextContains.withTextContains(MENU_ANTERIOR));
        ...
        actor.attemptsTo(Click.on(IMAGEN_CLARO_VIDEO), WaitFor.aTime(2000));
        ...
        actor.attemptsTo(Click.on(IMAGEN_CLARO_MUSICA), WaitFor.aTime(2000));
