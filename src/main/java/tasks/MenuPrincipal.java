...
public class MenuPrincipal implements Task {
    ...
    public MenuPrincipal(User addCredentials) {
    ...
    public static Performable menuPrincipal(User addCredentials) {
        return instrumented(MenuPrincipal.class, addCredentials);
    }
}