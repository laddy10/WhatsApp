...
public class WhatsappDefinitions {
  ...
  public void ingresarWhatsapp() {
    theActorCalled(" ").attemptsTo(IngresarWhatsApp.ingresar());
  }
  ...
  public void consultarSaldoLinea() {
    theActorInTheSpotlight().attemptsTo(ConsultarSaldoLinea.consultarSaldoLinea());
  }

  @And("^Seleccionar menu principal$")
  public void seleccionarMenuPrinciapl() {
    theActorInTheSpotlight().attemptsTo(MenuPrincipal.menuPrincipal());
  }

  @And("^Validar menu principal$")
  public void validarMenuPrincipal() {
    theActorInTheSpotlight().attemptsTo(ValidarMenuPrincipal.validarMenuPrincipal());
  }

  @And("^Ingresar al menu todo sobre tu linea$")
  public void ingresarMenuTodoSobreTuLinea() {
    theActorInTheSpotlight().attemptsTo(MenuTodoSobreTuLinea.menuTodoSobreTuLinea());
  }

  @Then("^Consultar los consumos$")
  public void consultarLosConsumos() {
    theActorInTheSpotlight().attemptsTo(ConsultarConsumos.ConsultarConsumos());
  }

  @Then("^Conoce o mejora tu plan$")
  public void conoceOMejoraTuPlan() {
    theActorInTheSpotlight().attemptsTo(ConoceMejoraTuPlan.conoceMejoraTuPlan());
  }

  @Then("^Consulta otra linea$")
  public void consultaOtraLinea() {
    theActorInTheSpotlight().attemptsTo(ConsultaOtraLinea.consultaOtraLinea());
  }

  @And("^Ingresar a la opcion tu lealtad merece mas$")
  public void opcionTuLealtadMereceMas() {
    theActorInTheSpotlight().attemptsTo(TuLealtadMereceMas.tuLealtadMereceMas());
  }
  ...
  public void seleccionarClaroDrive() {
    theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(CLARO_DRIVE));

    CapturaDePantallaMovil.tomarCapturaPantalla("Seleccionar Claro Drive");
    ReportHooks.registrarPaso("Seleccionar Claro Drive");

    theActorInTheSpotlight().attemptsTo(Click.on(BTN_ENVIAR_2), WaitFor.aTime(6000));
  }

  @Then("^Validar direccionamiento claro musica$")
  public void validarDireccionamientoClaroMusica() {
    theActorInTheSpotlight().attemptsTo(ValidarClaroMusica.validarClaroMusica());
  }

  @Then("^Validar direccionamiento claro Drive$")
  public void validarDireccionamientoClaroDrive() {
    theActorInTheSpotlight().attemptsTo(ValidarClaroDrive.validarClaroDrive());
  }

  @And("^Ingresar a haz tus recargas$")
  public void ingresarHazTusRecargas() {
    theActorInTheSpotlight().attemptsTo(HazTusRecargas.hazTusRecargas());
  }
  ...
  public void ingresarOtrasOpciones() {
    theActorInTheSpotlight().attemptsTo(OtrasOpciones.otrasOpciones());
  }

  @Then("^Validar el menu otras opciones$")
  public void validarMenuOtrasOpciones() {
    theActorInTheSpotlight().attemptsTo(ValidarMenuOtrasOpciones.validarMenuOtrasOpciones());
  }

  @Then("^Renueva tu sim$")
  public void renuevaTuSIM() {
    theActorInTheSpotlight().attemptsTo(RenuevaTuSIM.renuevaTuSIM());
  }

  @Then("^Cambiate a postpago$")
  public void CambiateaPost() {
    theActorInTheSpotlight().attemptsTo(CambiateaPost.cambiateaPost());
  }

  @Then("^Tus servicios LDI$")
  public void ServiciosLDI() {
    theActorInTheSpotlight().attemptsTo(ServiciosLDI.serviciosLDI());
  }

  @Then("^Validar menu LDI$")
  public void ValidarMenuLDI() {
    theActorInTheSpotlight().attemptsTo(ValidarMenuLDI.validarMenuLDI());
  }

  @And("^Ingresa al menu Compra por WhatsApp$")
  public void ingresarMenuCompraWhatsApp() {
    theActorInTheSpotlight().attemptsTo(CompraWhatsApp.compraWhatsApp());
  }
  ...
  public void botonSelecciona() {
    ...
    theActorInTheSpotlight().attemptsTo(EsperarYClickSeleccionaEnUltimoMensaje.conTimeout(20));
  }

  @And("^Validar el menu Compra por WhatsApp$")
  public void validarMenuCompraWhatsApp() {
    theActorInTheSpotlight().attemptsTo(MenuCompraWhatsApp.menuCompraWhatsApp());
  }
  ...
  public void ingresarMenuCompraTusPaquetes() {
    ...
    theActorInTheSpotlight()
        .attemptsTo(ClickTextoQueContengaX.elTextoContiene(COMPRA_TUS_PAQUETES));
  ...
  public void IngresarVerPuntosFisicos() {
    theActorInTheSpotlight().attemptsTo(VerPuntosFisicos.verPuntosFisicos());
  }

  @Then("^Validar el menu de tus equipos$")
  public void validarMenuTusEquipos() {
    theActorInTheSpotlight().attemptsTo(MenuTusEquipos.menuTusEquipos());
  }

  @Then("^Seleccionar tus PQRS radicados$")
  public void tusPqrRadicados() {
    theActorInTheSpotlight().attemptsTo(TusPQRSRadicados.tusPQRSRadicados());
  }

  @Then("^Validar consultar otra cuenta$")
  public void validarConsultarOtraCuenta() {
    theActorInTheSpotlight().attemptsTo(ConsultarOtraCuenta.consultarOtraCuenta());
  }
}
