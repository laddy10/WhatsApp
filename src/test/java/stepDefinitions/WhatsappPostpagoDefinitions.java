...
public class WhatsappPostpagoDefinitions {
    ...
    public void validarPoliticaTratamiendoDatosPost() {
        theActorInTheSpotlight().attemptsTo(TratamientoDatosPostpago.tratamientoDatosPostpago());
    }
    ...
    public void validarMenuPrincipalPost() {
        theActorInTheSpotlight().attemptsTo(ValidarMenuPrincipalPost.validarMenuPrincipalPost());
    }

    @And("^Ingresar al menu todo sobre tu plan postpago$")
    public void ingresarMenuTodoSobreTuPlanPostpago() {
        theActorInTheSpotlight().attemptsTo(MenuTodoSobreTuPlan.menuTodoSobreTuPlan());
    }

    @And("^Consultar consumos del plan postpago$")
    public void consultarConsumosPlanPostpago() {
        theActorInTheSpotlight().attemptsTo(ConsultaConsumosPostpago.consultaConsumosPostpago());
    }

    @And("^Conoce o mejora tu plan postpago$")
    public void conoceOMejoraTuPlanPostpago() {
        theActorInTheSpotlight().attemptsTo(ConoceMejoraPlanPostpago.conoceMejoraPlanPostpago());
    }

    @And("^Ingresar tu lealtad merece mas postpago$")
    public void tuLealtadMereceMaspost() {
        theActorInTheSpotlight().attemptsTo(TuLealtadMereceMasPost.tuLealtadMereceMasPost());
    }

    @And("^Seleccionar claro musica$")
    public void claroMusica() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(CLARO_MUSICA));

        CapturaDePantallaMovil.tomarCapturaPantalla("Seleccionar Claro Música");
        ReportHooks.registrarPaso("Seleccionar Claro Música");

        theActorInTheSpotlight()
                .attemptsTo(Click.on(BTN_ENVIAR_2), WaitForResponse.withText(URL_CLARO_MUSICA));
    }

    @And("^Seleccionar claro video$")
    public void claroVideo() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(CLARO_VIDEO));

        CapturaDePantallaMovil.tomarCapturaPantalla("Seleccionar Claro Video");
        ReportHooks.registrarPaso("Seleccionar Claro Video");

        theActorInTheSpotlight()
                .attemptsTo(Click.on(BTN_ENVIAR_2), WaitForTextContains.withTextContains(URL_CLARO_VIDEO));
    }

    @Then("^Validar direccionamiento claro video$")
    public void validarClaroVideo() {
        theActorInTheSpotlight().attemptsTo(ValidarClaroVideo.validarClaroVideo());
    }

    @Then("^Validar claro Drive Postpago$")
    public void validarClaroDrivePost() {
        theActorInTheSpotlight().attemptsTo(ValidarClaroDrivePost.validarClaroDrivePost());
    }

    @And("^Seleccionar la opcion claro Club$")
    public void claroClub() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(CLARO_CLUB));

        CapturaDePantallaMovil.tomarCapturaPantalla("Seleccionar Claro Club");
        ReportHooks.registrarPaso("Seleccionar Claro Club");

        theActorInTheSpotlight()
                .attemptsTo(Click.on(BTN_ENVIAR_2), WaitForTextContains.withTextContains(URL_CLARO_CLUB));
    }

    @Then("^Validar claro Club$")
    public void validarClaroClub() {
        theActorInTheSpotlight().attemptsTo(ValidarClaroClub.validarClaroClub());
    }

    @And("^Seleccionar la opcion aniversario Claro$")
    public void aniversarioClaro() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(ANIVERSARIO_CLARO));
        ...
        theActorInTheSpotlight()
                .attemptsTo(
                        Click.on(BTN_ENVIAR_2), WaitForTextContains.withTextContains(URL_ANIVERSARIO_CLARO));
    }

    @And("^Seleccionar la opcion sorpresa de cumpleanos$")
    public void sorpresaDeCumpleaños() {
        theActorInTheSpotlight()
                .attemptsTo(ClickTextoQueContengaX.elTextoContiene(SORPRESA_DE_CUMPLEAÑOS));
    ...
    public void validarAniversarioClaro() {
        theActorInTheSpotlight().attemptsTo(ValidarAniversarioClaro.validarAniversarioClaro());
    }

    @And("^Ingresar a tus pagos y facturas$")
    public void ingresarTusPagosFacturas() {
        theActorInTheSpotlight().attemptsTo(TusPagosFacturasPostpago.tusPagosFacturasPostpago());
    }

    @And("Ingresar al menu de tus pagos y facturas")
    public void ingresarAlMenuDeTusPagosYFacturas() {
        theActorInTheSpotlight().attemptsTo(IngresarTusPagosYFacturas.ingresarTusPagosYFacturas());
    }

    @And("Clic Tu factura")
    public void clicTuFactura() {
        theActorInTheSpotlight().attemptsTo(ClicTuFactura.clicTuFactura());
    }

    @And("Ingresar el codigo que llega en el mensaje de texto")
    public void ingresarElCodigoQueLlegaEnElMensajeDeTexto() {
        theActorInTheSpotlight().attemptsTo(IngresarCodigoVerificacion.ingresarCodigoVerificacion());
    }

    @And("Abrir factura")
    public void abrirFactura() {
        theActorInTheSpotlight().attemptsTo(AbrirFactura.abrirFactura());
    }

    @And("Seleccionar otras facturas claro")
    public void seleccionarOtrasFacturasClaro() {
        theActorInTheSpotlight().attemptsTo(OtrasFacturasClaro.otrasFacturasClaro());
    }

    @And("Seleccionar Tu historial")
    public void tuHistorial() {
        theActorInTheSpotlight().attemptsTo(ClicTuHistorial.clicTuHistorial());
    }

    @Then("Validar historial de facturas completo")
    public void historialFacturaCompleto() {
        theActorInTheSpotlight().attemptsTo(TuHistorialFacturas.tuHistorialFacturas());
    }

    @And("Seleccionar Mensaje de cobranza")
    public void mensajeCobranza() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(MENSAJES_COBRANZA));
    ...
    public void validarmensajeCasaCobranza() {
        theActorInTheSpotlight().attemptsTo(ValidarMensajesCobranza.validarMensajesCobranza());
    }

    @And("Seleccionar Productos financiados y validar mensaje")
    public void seleccionarProductosFinanciadosYValidar() {
        theActorInTheSpotlight().attemptsTo(ProductosFinanciados.productosFinanciados());
    }

    @And("Seleccionar Programa tus pagos")
    public void programaTusPagos() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(PROGRAMA_TUS_PAGOS));
    ...
    public void direccionamientoProgramarPagos() {
        theActorInTheSpotlight().attemptsTo(ProgramaTusPagos.programaTusPagos());
    }

    @And("Seleccionar Soporte y servicio")
    public void seleccionarSoporteServicio() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(SOPORTE_Y_SERVICIO));
    ...
    public void estadoServicios() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(ESTADO_SERVICIOS));
    ...
    public void fallasNavegacionDatos() {
        theActorInTheSpotlight().attemptsTo(FallasDatos.fallasDatos());
    }

    @Then("Validar fallas en hacer o recibir llamadas")
    public void fallasLlamadas() {
        theActorInTheSpotlight().attemptsTo(FallasLlamadas.fallasLlamadas());
    }

    @Then("Validar fallas otros servicios")
    public void fallasOtrosServicios() {
        theActorInTheSpotlight().attemptsTo(FallasOtrosServicios.fallasOtrosServicios());
    }

    @Then("Validar permita seleccionar opción Reporte robo o perdida")
    public void reporteRoboOPerdida() {
        theActorInTheSpotlight()
                .attemptsTo(ClickTextoQueContengaX.elTextoContiene(REPORTE_ROBO_PERDIDA));

        CapturaDePantallaMovil.tomarCapturaPantalla(
                "Validar que permita seleccionar opción Reporte robo o perdida");
        ...
        theActorInTheSpotlight().should(seeThat(ValidarElemento.esVisible(BTN_ENVIAR_2)));
    ...
    public void validarPQRRadicados() {
        theActorInTheSpotlight().attemptsTo(TusPQRRadicados.tusPQRRadicados());
    }

    @Then("Validar tus equipos en soporte y direccionamiento pagina Claro")
    public void validarTusEquiposSoporte() {
        theActorInTheSpotlight().attemptsTo(TusEquiposEnSoporte.tusEquiposEnSoporte());
    }

    @And("Seleccionar otras opciones")
    public void seleccionarOtrasOpciones() {
        theActorInTheSpotlight()
                .attemptsTo(ClickTextoQueContengaX.elTextoContiene(OTRAS_OPCIONES_POST));
    ...
    public void seleccionarRegistraTuEquipo() {
        theActorInTheSpotlight().attemptsTo(ClickTextoQueContengaX.elTextoContiene(REGISTRA_TU_EQUIPO));
    ...
    public void realizarRegistroDelEquipo() {
        theActorInTheSpotlight().attemptsTo(RegistraTuEquipo.registraTuEquipo());
    }

    @Then("Aceptar declaracion y confirmar datos")
    public void declaracionYConformirmarDatos() {
        theActorInTheSpotlight()
                .attemptsTo(ConfirmarDatosRegistraEquipo.confirmarDatosRegistraEquipo());
    }

    @Then("Realizar el proceso de regsitro")
    public void realizarProcesoRegistro() {
        theActorInTheSpotlight().attemptsTo(RealizarProcesoRegistro.realizarProcesoRegistro());
    }
    ...
    public void roamingInternacional() {
        ...
        theActorInTheSpotlight()
                .attemptsTo(ClickTextoQueContengaX.elTextoContiene(ROAMING_INTERNACIONAL));
    ...
    public void ingresarComprarRoaming() {
        theActorInTheSpotlight().attemptsTo(ComprarRoaming.comprarRoaming());
    }
    ...
    public void estadoRomaing() {
        theActorInTheSpotlight().attemptsTo(AdministarRoaming.administarRoaming());
    }
